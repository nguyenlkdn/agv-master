...
int main(int argc, char *argv[]) {
  ...
  actstation1 = gtk_button_new_with_label("Station 2");
  gtk_table_attach_defaults(GTK_TABLE(table), actstation1, 6, 7, 1, 2);

  actstation1 = gtk_button_new_with_label("Station 3");
  gtk_table_attach_defaults(GTK_TABLE(table), actstation1, 7, 8, 1, 2);

  actstation1 = gtk_button_new_with_label("Station 4");
  gtk_table_attach_defaults(GTK_TABLE(table), actstation1, 8, 9, 1, 2);

  actstation1 = gtk_button_new_with_label("Station 5");
  gtk_table_attach_defaults(GTK_TABLE(table), actstation1, 9, 10, 1, 2);
